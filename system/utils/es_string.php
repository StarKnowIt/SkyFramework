...
class es_string {
	 ...
	 * @param es_string $str
	 *        	需要转换的字符串
	 * @param es_string $start
	 *        	开始位置
	 * @param es_string $length
	 *        	截取长度
	 * @param es_string $charset
	 *        	编码格式
	 * @param es_string $suffix
	 *        	截断显示字符
	 * @return es_string
	 */
	 ...
	 * @param es_string $len
	 *        	长度
	 * @param es_string $type
	 *        	字串类型
	 *        	0 字母 1 数字 其它 混合
	 * @param es_string $addChars
	 *        	额外字符
	 * @return es_string
	 */
